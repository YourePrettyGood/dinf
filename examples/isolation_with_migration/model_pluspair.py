...
#Added feature combining the two populations 2026/07/02
import string
...
populations = ["deme1", "deme2", "deme1+deme2"]
...
features = dinf.MultipleBinnedHaplotypeMatrices(
    num_individuals={pop: len(pop.split("+"))*num_individuals for pop in populations},
...
def generator(seed, **params):
    ...
    ts = msprime.sim_ancestry(
        samples={pop: num_individuals for pop in populations if len(pop.split("+")) == 1},
        demography=demog,
